<script>    
    ...
    function obliczKredyt() {
        try {
            console.log("Oblicz button clicked");
            const formSection = document.getElementById("formSection");
            const resultSection = document.getElementById("resultSection");
            const compareCheckbox = document.getElementById("porownajKredyt");
            const benefitSummary = document.getElementById("benefitSummary");
            if (!formSection || !resultSection || !compareCheckbox || !benefitSummary) {
                throw new Error("Required elements not found");
            }
    
            let dane1 = obliczKredytDlaFormularza();
            if (!dane1) {
                console.log("Calculation for first form failed");
                return;
            }
            harmonogram1Data = dane1.harmonogram;
            aktualizujWyniki(dane1);
    
            if (compareCheckbox.checked) {
                let dane2 = obliczKredytDlaFormularza("2");
                if (!dane2) {
                    console.log("Calculation for second form failed");
                    return;
                }
                harmonogram2Data = dane2.harmonogram;
                aktualizujWyniki(dane2, "2");
    
                const kosztRoznica = dane1.calkowityKoszt - dane2.calkowityKoszt;
                const okresRoznica = dane1.okresPoNadplacie - dane2.okresPoNadplacie;
                const procentKorzysci = ((dane1.calkowityKoszt - dane2.calkowityKoszt) / dane1.calkowityKoszt * 100).toFixed(2);
                ...
                document.getElementById("benefitPercentageValue").textContent = `${procentKorzysci}`;
            ...
            console.log("Calculation completed, results displayed");
        } catch (error) {
    ...
    function initializeButtons() {
        try {
            ...
            if (obliczBtn) {
                obliczBtn.addEventListener("click", obliczKredyt);
                console.log("Oblicz button initialized");
            } else {
                console.error("Oblicz button not found");
            }
            ...
            if (returnToFormBtn) {
                returnToFormBtn.addEventListener("click", showForm);
                console.log("Return to Form button initialized");
            } else {
                console.error("Return to Form button not found");
            }
    
            const toggleHarmonogram1 = document.getElementById("toggleHarmonogram1");
            if (toggleHarmonogram1) {
                toggleHarmonogram1.addEventListener("click", () => toggleHarmonogram("harmonogramContent", "toggleHarmonogram1"));
                console.log("Harmonogram 1 toggle initialized");
            } else {
                console.error("Harmonogram 1 toggle not found");
            }
    
            const toggleHarmonogram2 = document.getElementById("toggleHarmonogram2");
            if (toggleHarmonogram2) {
                toggleHarmonogram2.addEventListener("click", () => toggleHarmonogram("harmonogramContent2", "toggleHarmonogram2"));
                console.log("Harmonogram 2 toggle initialized");
            } else {
                console.error("Harmonogram 2 toggle not found");
            }
    
            const compareCheckbox = document.getElementById("porownajKredyt");
            if (compareCheckbox) {
                compareCheckbox.addEventListener("change", toggleCompareSection);
                console.log("Compare checkbox initialized");
            } else {
                console.error("Compare checkbox not found");
            }
    
            const nadplataCheckbox = document.getElementById("wlaczNadplate");
            if (nadplataCheckbox) {
                nadplataCheckbox.addEventListener("change", toggleNadplataSection);
                console.log("Nadplata checkbox 1 initialized");
            } else {
                console.error("Nadplata checkbox 1 not found");
            }
    
            const nadplataCheckbox2 = document.getElementById("wlaczNadplate2");
            if (nadplataCheckbox2) {
                nadplataCheckbox2.addEventListener("change", toggleNadplataSection2);
                console.log("Nadplata checkbox 2 initialized");
            } else {
                console.error("Nadplata checkbox 2 not found");
            }
        } catch (error) {
