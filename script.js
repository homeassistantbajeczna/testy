...
function initializeNadplataKredytuGroup(group) {
    ...
    const updateOverpaymentLimit = (input, range, group) => {
        ...
        if (type !== "Jednorazowa") {
            ...
            maxAllowed = maxAllowed / (frequencyMultiplier || 1);
        }
        ...
        for (let i = 0; i <= currentIndex; i++) {
            ...
            totalOverpayment += gValue * (frequencyMultiplier || 1);
        }
        ...
        for (let i = 1; i <= iloscRat; i++) {
            ...
            if (activeOverpayment) {
                ...
                if (nadplata > 0) {
                    ...
                    if (activeOverpayment.effect === "Skróć okres") {
...
// Dodajemy aktualizację limitów przy zmianie kwoty kredytu w sekcji inicjalizacji
